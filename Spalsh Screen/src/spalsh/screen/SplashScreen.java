...
public class SplashScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SplashScreen/Assets/coba.png"))); // NOI18N
        ...
        background.add(load, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 990, -1, -1));
        ...
        time.setText("0");
        background.add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(1840, 980, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            for(int i=0; i<=100; i++){
                ...
                if(i==90){
                    sp.load.setText("Menjalankan Aplikasi");
                }
                if(i==100){
            ...
            System.out.println("Semangat mabro");
        }
    }
